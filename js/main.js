...
---------------------------- */
  ...
  $("header ul li ul,.header-bottom-two ul li ul ,.magamenu ")
    .parent("li")
    .addClass("drop-icon re-icon");
...
------------------------------ */
  $(
    "#new-products,#tab-carousel-1,#tab-carousel-2,#tab-carousel-3,#tab-carousel-4,#tab-carousel-5"
  ).owlCarousel({
    autoPlay: false,
    slideSpeed: 1000,
    pagination: false,
